...
# The first assignment is exclusively about Python and asks you to solve small tasks. Insert your solution in the cells marked with `TODO: implement`. For each exercise, we have written a few unit tests so you are able to check your implementation right away (keep in mind that passing the unit tests does not necessarily mean your implementation computes the desired output for all possible inputs of your function!). In case you have questions, feel free to use our [forum](https://edsai20.cs.uni-saarland.de/). 

# #### Submission Details
# Upload your submission to our [CMS](https://cms.sic.saarland/edsai20/) in groups of three students until **November 23, 2020 10:00 am**. Late submissions will not be graded! The submission should be uploaded by exactly **one** team member. Make sure that your submission contains the name and matriculation number of each team member. For this purpose, fill out the cell below. Your submission should only contain this **.ipynb** file.

# In[1]:


# Team information (name - matriculation number)
# August von Liechtenstein - 7002304
# Baris Kitay - 7006859
# Viet Dao Quoc - 7010834
